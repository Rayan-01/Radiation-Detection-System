...
> &
  React.ComponentProps<'div'> & {
    ...
    nameKey?: string;
    labelKey?: string;
    payload?: AnyPayloadItem[] | null;
    label?: any;
    formatter?: ((value: any, name?: string, item?: AnyPayloadItem, index?: number, extra?: any) => React.ReactNode) | undefined;
    color?: string;
  };
...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const [item] = payload as AnyPayloadItem[];
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {(payload ?? []).map((item: AnyPayloadItem, index: number) => {
            ...
            >
              {itemConfig?.icon && !hideIcon ? (
                ...
                <div
                  ...
                  style={{
                    backgroundColor: (item.color as string) || (item.payload?.color as string),
                  }}
                />
              )}
              {itemConfig?.label}
